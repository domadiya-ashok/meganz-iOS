...
class NasaModel : ObservableObject {
    ...
    func fetchData() async {
        ...
        // TODO: clean
//        guard let url = URL(string: "https://api.nasa.gov/planetary/apod?api_key=DEMO_KEY&start_date=\(formatter.string(from: rangeOfDate.0))&end_date=\(formatter.string(from: rangeOfDate.1))") else {
//            print("URL is not valid!")
//            return
//        }
